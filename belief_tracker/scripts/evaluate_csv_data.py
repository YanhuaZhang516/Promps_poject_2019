...
def main():
    ...
    file_path ="/home/doro/ias_ros/src/pomdp_collision/belief_tracker/recorded_data/doro_r_l.csv"
    ...
    #goals = np.genfromtxt("/home/albert/trajectories/goals_user_study_new.csv", dtype=float, delimiter=",",
                          #skip_header=1)
    goals = np.genfromtxt("/home/doro/ias_ros/src/pomdp_collision/belief_tracker/data/goals/goals_doro_r_l.csv", dtype=float, delimiter=",",
                          skip_header=1)
    ...
    for i in range(1,5):
        ...
        goal_counts = np.zeros([len(goals)]*(i+1))
        ...
        #                 goal_counts[i,j,k,l] = goal_counts[i,j,k,l] / sums[i,j,k,l]
        ...
        goal_counts[np.isnan(goal_counts)]=0.0
    ...
    print history_transition_data[1][1,0,1]
    print history_transition_data[1][1,0,2]
    print history_transition_data[1][1, 0, 3]
